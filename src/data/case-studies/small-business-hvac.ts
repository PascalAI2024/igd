...
export const hvacCaseStudy: CaseStudy = {
  ...
  subtitle: 'How a Local HVAC Business Grew Their Customer Base by 65% with Digital Tools',
  ...
  results: [
    '65% increase in service calls within 14 months',
    'Expanded from 3 to 5 service technicians',
    'Reduced scheduling errors by 70%',
    '45% increase in preventative maintenance contracts',
  ...
  metrics: {
    'Lead Generation': 'From 22 to 45 new leads per month',
    'Dispatch Efficiency': '25% more service calls completed per day',
    'Customer Feedback': '4.5/5 average rating across platforms',
    'Maintenance Contract Renewals': 'Increased from 62% to 82%',
    'Average Invoice Value': 'Increased by 18% through upselling'
  },
  icon: Thermometer,
  services: [
    'Web Development',
